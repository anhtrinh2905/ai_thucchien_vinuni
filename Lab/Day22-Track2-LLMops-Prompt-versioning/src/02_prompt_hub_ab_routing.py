...
PROMPT_V1_NAME = "anhtrinh-rag-prompt-v1"
PROMPT_V2_NAME = "anhtrinh-rag-prompt-v2"
...
SYSTEM_V1 = "Bạn là trợ lý AI hữu ích. Chỉ dùng context sau để trả lời. Giữ câu trả lời ngắn gọn (2-4 câu). Nếu context không có thông tin, hãy nói rõ là không tìm thấy."
...
SYSTEM_V2 = "Bạn là chuyên gia AI. Đọc kỹ context, xác định facts liên quan, viết câu trả lời rõ ràng và có tổ chức (3-5 câu). Chỉ dựa trên context, không suy đoán thêm."
